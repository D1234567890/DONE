...
public class Goodbye {
	...
	void frameDisplayer() {
		...
		label.setFont(font);
		label.setText(
				"Goodbye! Hope you enjoyed using me and be sure to tell other people about it! This is your custom-made message inprinted with your favorite color!");
		panel.add(label);
		if (james.favoriteColorr.contains("red")) {
			...
			james.joptionpane = "I am sorry! I cannot make a brown message (your favorite color) for this because I do not have the ability!";
			...
			james.joptionpane = "I am sorry! I do not know of such a color of " + james.favoriteColorr
					+ " to make your special custom-made message that color!";
			james.speak(james.joptionpane);
			JOptionPane.showMessageDialog(null, james.joptionpane);
		}
