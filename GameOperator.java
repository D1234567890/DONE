...
public class GameOperator {
	...
	void playGames() {
		...
		int firstOptionDialogue = JOptionPane.showOptionDialog(null, j.joptionpane, "Games", 0,
		...
		while (!game.equalsIgnoreCase("number game") && !game.equalsIgnoreCase("number guessing game")
				&& !game.equalsIgnoreCase("rock paper scissors") && !game.equalsIgnoreCase("rock, paper, scissors")
				&& !game.equalsIgnoreCase("memorizing game")) {
			game = JOptionPane
					.showInputDialog("I don't know how to play this game yet. Please enter a different game.");
		}
		if (game.equalsIgnoreCase("memorizing game")) {
			if (j.voiceOn) {
				...
				j.joptionpane = "I cannot play this game without my voice on!";
				j.speak(j.joptionpane);
				JOptionPane.showMessageDialog(null, j.joptionpane);
				madeItToTheEnd = true;
			}
		...
		if (game.equalsIgnoreCase("number game") || game.equalsIgnoreCase("number guessing game")) {
			...
			gameOptions1[0] = "Easy";
			gameOptions1[1] = "Hard";
			int thirdOptionDialog = JOptionPane.showOptionDialog(null, j.joptionpane, "Choose which One!", 0,
					JOptionPane.INFORMATION_MESSAGE, null, gameOptions1, null);
			if (thirdOptionDialog == 0) {
				...
				while (!hasGotAnswer) {
					...
					while (guess.charAt(0) != '1' && guess.charAt(0) != '2' && guess.charAt(0) != '3'
							&& guess.charAt(0) != '4' && guess.charAt(0) != '5' && guess.charAt(0) != '6'
							&& guess.charAt(0) != '7' && guess.charAt(0) != '8' && guess.charAt(0) != '9'
							&& guess.charAt(0) != '0') {
			...
			if (j.voiceOn) {
				...
				for (int i = 0; i < 3; i++) {
					...
					if (newnewnewnewnewrandom == 0) {
						...
						while (!winorlose.equalsIgnoreCase("rock") && !winorlose.equalsIgnoreCase("paper")
								&& !winorlose.equalsIgnoreCase("scissors")) {
				...
				if (user < Jamie) {
					j.joptionpane = "I won! YAY!! Jamie: " + Jamie + "! " + j.name + ": " + user + "! " + "Ties: "
							+ ties + "!";
					j.speak(j.joptionpane);
					JOptionPane.showMessageDialog(null, j.joptionpane);
				}
			} else {
				j.joptionpane = "You can't play rock, paper, scissors without my voice on!";
				j.speak(j.joptionpane);
				JOptionPane.showMessageDialog(null, j.joptionpane);
			}
		}
